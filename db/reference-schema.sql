...
-- Instructors are stored as app_user rows with role = 'INSTRUCTOR' (no separate instructor table).
...
-- version column supports JPA optimistic locking (@Version).
...
-- -------------------------------------------------------------------------
-- ATTENDANCE  (one record per user per session)
-- -------------------------------------------------------------------------
